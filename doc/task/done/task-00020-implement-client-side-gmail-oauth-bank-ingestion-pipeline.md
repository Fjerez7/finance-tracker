...
- [x] Implement `GmailAuthService` handling interactive sign-in, token refresh, authorization checks, and sign-out.
...
- [x] Triggering sync fetches live bank notification emails directly from Gmail.
